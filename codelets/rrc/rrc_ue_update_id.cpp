...
jbpf_ringbuf_map(rrc_ue_update_id_output_map, rrc_ue_update_id, 256);

struct jbpf_load_map_def SEC("maps") output_map_tmp = {
  .type = JBPF_MAP_TYPE_ARRAY,
  .key_size = sizeof(int),
  .value_size = sizeof(rrc_ue_update_id),
  .max_entries = 1,
};
