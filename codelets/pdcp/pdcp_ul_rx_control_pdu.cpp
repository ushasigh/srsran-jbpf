...
uint64_t jbpf_main(void* state)
{
    ...
    uint32_t pdu_length = (uint32_t) ctx->srs_meta_data1;

#ifdef DEBUG_PRINT
    jbpf_printf_debug("PDCP UL RX CONTROL PDU: cu_ue_index=%d, rb_id=%d, pdu_length=%d\n", 
        pdcp_ctx.cu_ue_index, rb_id, pdu_length);
#endif
