...
uint64_t jbpf_main(void* state)
{
    ...
    uint32_t hdr_length = (uint32_t) (ctx->srs_meta_data1 & 0xFFFFFFFF);
    uint32_t pdu_length = sdu_length + hdr_length;    

#ifdef DEBUG_PRINT
    jbpf_printf_debug("PDCP UL RX DATA PDU: cu_ue_index=%d, rb_id=%d, sdu_length=%d\n", 
