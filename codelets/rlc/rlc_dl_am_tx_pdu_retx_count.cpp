...
uint64_t jbpf_main(void* state)
{
    ...
    if (out->stats[ind % MAX_NUM_UE_RB].has_am) {
        ...
        /////////////////////////////////////////////
        // pdu_retx_count
        out->stats[ind % MAX_NUM_UE_RB].am.pdu_retx_count.count++;
        out->stats[ind % MAX_NUM_UE_RB].am.pdu_retx_count.total += retx_count;
        if (out->stats[ind % MAX_NUM_UE_RB].am.pdu_retx_count.min > retx_count) {
            out->stats[ind % MAX_NUM_UE_RB].am.pdu_retx_count.min = retx_count;
        }
        if (out->stats[ind % MAX_NUM_UE_RB].am.pdu_retx_count.max < retx_count) {
            out->stats[ind % MAX_NUM_UE_RB].am.pdu_retx_count.max = retx_count;
        }    
